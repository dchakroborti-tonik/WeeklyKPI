-- drop table if exists `dap_ds_poweruser_playground.collection_weekly_kpi_v2`;

-- create table `dap_ds_poweruser_playground.collection_weekly_kpi_v2` as 
-- insert into `dap_ds_poweruser_playground.collection_weekly_kpi_v2`
WITH
  dt AS (
  SELECT
    DATE('2022-11-28') WkstartDate,
    DATE('2022-12-04') WkendDate),
