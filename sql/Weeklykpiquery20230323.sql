-- create table `dap_ds_poweruser_playground.collection_weekly_kpi_v3` as 
insert into `dap_ds_poweruser_playground.collection_weekly_kpi_v3`
WITH
  dt AS (
  SELECT
    DATE('2022-12-26') WkstartDate,
    DATE('2023-01-01') WkendDate),
